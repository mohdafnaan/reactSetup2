const RestaurantCard = (props) => {
  ...
  return (
    <div className="w-64 min-h-80 cursor-pointer bg-linear-to-br from-pink-50 via-orange-50 to-yellow-50 rounded-2xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 p-3 border border-pink-200">
      <img
